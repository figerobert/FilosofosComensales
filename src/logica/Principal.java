...
public class Principal {
    ...
    private JTextField jTxtNoFilosofos = new JTextField();
    ...
    public Principal(Clase10Control clase10Control) { 
        ...
        String NoFilosofos = clase10Control.getNoFilosofos();

        // Se crea el Array para contener las 5 instancias de Tenedores:
        Tenedor[] tenedor = new Tenedor[Integer.parseInt(NoFilosofos)];
        // Se crea el Array para contener las 5 instancias de Filósofos:
        Filosofo[] filosofo = new Filosofo[Integer.parseInt(NoFilosofos)];
        ...
        for(int i=0; i<filosofo.length; i++){
            ...
            */
            ...
            filosofo[i] = new Filosofo(i, tenedor[i], tenedor[(i+1)%Integer.parseInt(NoFilosofos)], comensal, jLabel_F[i], jLabel_T[i], jLabel_T[(i+1)%Integer.parseInt(NoFilosofos)], log, jTextField_C[i]);
        }
